...
%global AppVersion 6.3
%global AppRelease 20211021
...
%description
These are the example/test programs from the ncurses 6.3 distribution,
for patch-date 20211021.
...
These are the example/test programs from the ncurses 6.3 distribution,
for patch-date 20211021, using the "ncurseswt" library to demonstrate the
